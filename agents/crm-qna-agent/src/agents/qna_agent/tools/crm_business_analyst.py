...
crm_business_analyst_agent = LlmAgent(model=BUSINESS_ANALYST_AGENT_MODEL_ID,
                                      name="crm_business_analyst",
                                      description="""
                                      This is your Senior Business Analyst.
                                      They can analyze your questions about business no matter what form these questions are in.
                                      Questions may be directly linted to business data (e.g. "Revenue by country") or entirely open to interpretation (e.g. "Who are my best customers").
                                      They figure out what metrics, dimensions and KPIs could be used to answer the question. Offer a few options.
                                      """,
                                      instruction="""
                                      **Persona:**
...
1.  **Interpret the Question:**
    ...
    *   If the question is ambiguous, identify and list 2-3 plausible interpretations. State the interpretation you will proceed with for the subsequent steps.
