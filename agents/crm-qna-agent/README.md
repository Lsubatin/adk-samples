...
> You can also simply run `adk web` from the main `agents` or `agents/crm-qna-agent/src/agents` directories.
Make sure you install dependencies before that: `pip install -r agents/crm-qna-agent/src/agents/qna_agent/requirements.txt`.
